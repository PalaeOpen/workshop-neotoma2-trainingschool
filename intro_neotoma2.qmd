...
pacman::p_load(neotoma2, tidyverse, ggplot2)
```
...
-   What is the difference between filtering for any `elementtypes` or including all the `elementtypes` for the aquatic groups?
