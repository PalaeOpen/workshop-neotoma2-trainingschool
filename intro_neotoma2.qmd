...
-   Taxa
-   Counts
-   Stratigraphic plots -->  more in day 3 Thursday 18/07/26 (link)
...
Another classifier of the taxon list in Neotoma is the `ecologicalgroup`. In Tilia this is shown in the column *Group*. The function `get_table()` can be used to pull existing table names in Neotoma. For instance, to see description of ecological groups: `neotoma2::get_table("ecolgrouptypes", limit = 100)`
